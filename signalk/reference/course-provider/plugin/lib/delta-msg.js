...
exports.buildDeltaMsg = buildDeltaMsg;
 ...
 */
function buildDeltaMsg(course, method) {
    const source = method === 'Rhumbline' ? course.rl : course.gc;
    const values = new Array(VALUES_LENGTH);
...
//# sourceMappingURL=delta-msg.js.map